...
Fits SPQR using either MLE or MAP method and computes K-fold
...
- control:
  ...
  These parameters are similar to those in `rstan::stan()`. Detailed
  explanations can be found in the Stan reference manual.
